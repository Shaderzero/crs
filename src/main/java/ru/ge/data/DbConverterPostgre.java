    ...
    public static Counterparty convertCounterparty(Counterparty2 entity) {
        ...
        try {
            ...
            if (list.size() > 0) {
                ...
                result.setLongTerm(entity.isLongTerm() == null ? false : entity.isLongTerm());
                result.setETP(entity.isETP() == null ? false : entity.isETP());
                result.setEFET(entity.isEFET() == null ? false : entity.isEFET());
                result.setGtc(entity.getGtc());
                session.beginTransaction();
                session.save(result);
                session.getTransaction().commit();
    ...
    public static Guarantee convertGuarantee(Guarantee2 entity) {
        ...
        try {
            ...
            if (result == null) {
                ...
                result.setCurrencyP(convertCurrency(entity.getCurrency()));
